            ...
            <div class="attr-modal-header">
                <ul class="tb-nav tb-nav-tabs ekit_menu_control_nav" role="tablist">
                    ...
                    <li role="presentation" id="attr_badge_nav"><a class="attr-nav-link" href="#attr_vertical_menu_setting_tab" aria-controls="attr_vertical_menu_setting_tab"
                            role="tab" data-attr-toggle="tab"><?php esc_html_e('Extra', 'elementskit'); ?></a></li>
                </ul>
            </div>
            <div class="attr-modal-body ekit-wid-con">
                <div class="attr-tab-content">
                    ...
                    <div role="tabpanel" class="attr-tab-pane" id="attr_vertical_menu_setting_tab">
                        <div id="vertical_megamenu_position_type">
                            <strong><?php esc_html_e('Vertical Mega Menu Position as:'); ?></strong>
                            <span><input type="radio" name="position_type" checked value="relative_position"> <?php esc_html_e('Relative'); ?></span>
                            <span><input type="radio" name="position_type" value="top_position"> <?php esc_html_e('Top'); ?></span>
                        </div>
                        <table class="option-table">
                            <tbody>
                                <tr>
                                    <td><strong><?php esc_html_e('Vertical Menu Width', 'elementskit'); ?></strong></td>
                                    <td class="alignright">
                                        <input type="text"
                                            placeholder="<?php esc_html_e('Vertical Menu Width', 'elementskit'); ?>"
                                            id="elementskit-menu-vertical-menu-width-field" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
