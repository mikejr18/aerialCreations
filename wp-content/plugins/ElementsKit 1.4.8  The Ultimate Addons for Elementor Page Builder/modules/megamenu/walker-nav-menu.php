...
class Elementskit_Menu_Walker extends \Walker_Nav_Menu
{
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if (in_array('menu-item-has-children', $classes) || $is_megamenu_item == true) {
            $class_names .= ' elementskit-dropdown-has '.$item_meta['vertical_megamenu_position_type'].'';
        }
        ...
        // New
        $data_attr = $item_meta['vertical_menu_width'] ? 'data-vertical-menu='.$item_meta['vertical_menu_width'].'' : '';
        //
