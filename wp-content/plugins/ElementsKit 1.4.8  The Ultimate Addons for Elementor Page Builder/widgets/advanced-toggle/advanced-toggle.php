...
use \ElementsKit\Elementskit_Widget_Advanced_Toggle_Handler as Handler;
...
class Elementskit_Widget_Advanced_Toggle extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
			...
			[
				'raw' => '<strong>' . __( 'Please note!', 'elementor' ) . '</strong> ' . __( 'This style show\'s only first two tabs.', 'elementskit' ),
