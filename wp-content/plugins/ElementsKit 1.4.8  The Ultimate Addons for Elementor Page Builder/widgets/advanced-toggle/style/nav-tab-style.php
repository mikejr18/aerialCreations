    ...
    <div class="elemenetskit-toogle-controls-wraper-outer">
        <div class="elemenetskit-toogle-controls-wraper">
            ...
            <ul class="nav nav-tabs elementkit-tab-nav" role="tablist">
                ...
                ?>
                    <li class="elementor-repeater-item-<?php echo esc_attr( $toggle[ '_id' ] ); ?> <?php if ($toggle['ekit_toggle_title'] == '') { ?> ekit-tab-no-title <?php }; ?>">
        ...
        ?>
            ...
            aria-labelledby="content-<?php echo esc_attr($toggle['_id'].$toggle_id); ?>-tab">
                <div class="animated fadeIn">
                    <?php echo \ElementsKit\Modules\Controls\Widget_Area_Utils::parse( $toggle['ekit_toggle_content'], $this->get_id(), ($i + 1) ); ?>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
