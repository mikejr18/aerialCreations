<div class="ekit-slide-toggle-wraper">
    <div class="ekit-switch-nav-wraper-outer">
        <label class="nav nav-tabs ekit-slide-toggle" id="nav-tab" role="tablist">
        <?php 
            $toggleItem = 0;
    ...
    ?>
        ...
        >   
            <div class="animated fadeIn">
                <?php echo \ElementsKit\Modules\Controls\Widget_Area_Utils::parse( $toggle['ekit_toggle_content'], $this->get_id(), ($item + 1) ); ?>
            </div>
        </div>
    <?php }; ?>
    </div>
