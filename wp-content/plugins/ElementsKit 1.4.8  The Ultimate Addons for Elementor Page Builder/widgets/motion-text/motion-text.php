    ...
    protected function render_raw( ) {
		...
		<div class="elementskit_motion_text_wraper">
			...
			<?php
				...
				if ($url !== '') {
					echo '<a '. $this->get_render_attribute_string( 'button' ) .'><span class="ekit_motion_text" data-ekit-animation-delay="'.esc_attr($animation_delay_char_based).'">'.\ElementsKit\Utils::kses( $title_text ).'</span></a>';
				} else {
