...
class Element_Pack_License_Page {
    ...
    public function action_activate_license() {
            ...
            self::set_license_key( 'plugintheme' );
            self::set_license_email( 'info@plugintheme.net' );
            
            $this->notice = 'success';

            wp_die( 'success', __( 'Element Pack', 'bdthemes-element-pack' ), [
                'link_url' => 'http:///wp-admin/admin.php?page=elementor',
                'link_text' => 'Go Back',
            ] );
    ...
    public function admin_notice(){return;
