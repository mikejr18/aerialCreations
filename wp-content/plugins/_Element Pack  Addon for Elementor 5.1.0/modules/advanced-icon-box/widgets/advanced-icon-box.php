	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'(desktop){{WRAPPER}}.bdt-readmore-on-hover-yes .bdt-advanced-icon-box-readmore' => 'transform: translate({{readmore_horizontal_offset.SIZE || 0}}px, {{readmore_vertical_offset.SIZE || 0}}px);',
					'(tablet){{WRAPPER}}.bdt-readmore-on-hover-yes .bdt-advanced-icon-box-readmore' => 'transform: translate({{readmore_horizontal_offset_tablet.SIZE || 0}}px, {{readmore_vertical_offset_tablet.SIZE || 0}}px);',
					'(mobile){{WRAPPER}}.bdt-readmore-on-hover-yes .bdt-advanced-icon-box-readmore' => 'transform: translate({{readmore_horizontal_offset_mobile.SIZE || 0}}px, {{readmore_vertical_offset_mobile.SIZE || 0}}px);',
				],
				'condition' => [
					'readmore_on_hover' => 'yes',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'(desktop){{WRAPPER}} .bdt-indicator-svg' => 'transform: translate({{indicator_horizontal_offset.SIZE || 0}}px, {{indicator_vertical_offset.SIZE || 0}}px) rotate({{indicator_rotate.SIZE || 0}}deg);',
					'(tablet){{WRAPPER}} .bdt-indicator-svg' => 'transform: translate({{indicator_horizontal_offset_tablet.SIZE || 0}}px, {{indicator_vertical_offset_tablet.SIZE || 0}}px) rotate({{indicator_rotate_tablet.SIZE || 0}}deg);',
					'(mobile){{WRAPPER}} .bdt-indicator-svg' => 'transform: translate({{indicator_horizontal_offset_mobile.SIZE || 0}}px, {{indicator_vertical_offset_mobile.SIZE || 0}}px) rotate({{indicator_rotate_mobile.SIZE || 0}}deg);',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'(desktop){{WRAPPER}} .bdt-advanced-icon-box-badge' => 'transform: translate({{badge_horizontal_offset.SIZE || 0}}px, {{badge_vertical_offset.SIZE || 0}}px) rotate({{badge_rotate.SIZE || 0}}deg);',
					'(tablet){{WRAPPER}} .bdt-advanced-icon-box-badge' => 'transform: translate({{badge_horizontal_offset_tablet.SIZE || 0}}px, {{badge_vertical_offset_tablet.SIZE || 0}}px) rotate({{badge_rotate_tablet.SIZE || 0}}deg);',
					'(mobile){{WRAPPER}} .bdt-advanced-icon-box-badge' => 'transform: translate({{badge_horizontal_offset_mobile.SIZE || 0}}px, {{badge_vertical_offset_mobile.SIZE || 0}}px) rotate({{badge_rotate_mobile.SIZE || 0}}deg);',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'(desktop){{WRAPPER}} .bdt-advanced-icon-box-icon' => 'transform: translate({{top_icon_horizontal_offset.SIZE}}{{UNIT}}, -{{top_icon_vertical_offset.SIZE}}px);',
					'(tablet){{WRAPPER}} .bdt-advanced-icon-box-icon' => 'transform: translate({{top_icon_horizontal_offset_tablet.SIZE}}{{UNIT}}, -{{top_icon_vertical_offset_tablet.SIZE}}px);',
					'(mobile){{WRAPPER}} .bdt-advanced-icon-box-icon' => 'transform: translate({{top_icon_horizontal_offset_mobile.SIZE}}{{UNIT}}, -{{top_icon_vertical_offset_mobile.SIZE}}px);',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'(desktop){{WRAPPER}} .bdt-advanced-icon-box-icon' => 'transform: translate({{left_right_icon_horizontal_offset.SIZE}}{{UNIT}}, {{left_right_icon_vertical_offset.SIZE}}{{UNIT}});',
					'(tablet){{WRAPPER}} .bdt-advanced-icon-box-icon' => 'transform: translate({{left_right_icon_horizontal_offset_tablet.SIZE}}{{UNIT}}, {{left_right_icon_vertical_offset_tablet.SIZE}}{{UNIT}});',
					'(mobile){{WRAPPER}} .bdt-advanced-icon-box-icon' => 'transform: translate({{left_right_icon_horizontal_offset_mobile.SIZE}}{{UNIT}}, {{left_right_icon_vertical_offset_mobile.SIZE}}{{UNIT}});',
				],
			]
		);
