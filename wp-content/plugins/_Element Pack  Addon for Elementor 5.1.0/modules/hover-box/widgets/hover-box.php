...
class Hover_Box extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-hover-box.bdt-hover-box-skin-envelope .bdt-box-item-wrapper>.bdt-active:before' => 'width: {{SIZE}}{{UNIT}}; left: -{{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'_skin' => 'bdt-envelope'
				]
	...
	protected function render() {
		...
		if ( 'yes' == $settings['box_image_effect'] ) {
			$this->add_render_attribute( 'hover_box', 'class', 'bdt-hover-box-image-effect' );
		}
