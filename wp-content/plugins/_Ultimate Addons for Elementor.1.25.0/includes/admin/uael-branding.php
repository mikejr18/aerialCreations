						...
						<div class="inside">
							<div class="form-wrap">
								...
								<div class="form-field">
									...
									<input type="text" placeholder="https://uaelementor.com/docs/" name="uael_white_label[knowledgebase_url]" id="uael-wl-knowledgebase-url" class="placeholder placeholder-active" value="<?php echo esc_url( $settings['knowledgebase_url'] ); ?>">
									</p>
								</div>
								<hr>
								<div class="form-field">
									...
									<input type="text" placeholder="https://uaelementor.com/support/" name="uael_white_label[support_url]" id="uael-wl-support-url" class="placeholder placeholder-active" value="<?php echo esc_url( $settings['support_url'] ); ?>">
									</p>
								</div>
								<hr>
								<div class="form-field">
